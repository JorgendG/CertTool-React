    ...
    return (
        <div>
            ...
            <form onSubmit={handleCSRSubmit}>
                <fieldset>
                    <InputAttribute label='Common Name' name='cn' onChange={handleChange}/>
                    <InputAttribute label='SAN' name='san' onChange={handleChange}/>
                    <InputAttribute label='Organization' name='o' onChange={handleChange}/>
                    <InputAttribute label='Department' name='ou' onChange={handleChange}/>
